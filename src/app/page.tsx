...
import { MagneticButton } from "./utils/Magnetic/MagneticUtils";
            ...
            <div className="flex flex-col gap-10">
                <BlogPost title="How to Build a Magnetic Button Component in React" author="TheWeakNinja" date="January 1, 2021">
                    <p>
                        ...
                        sapien. Fusce commodo ipsum eu lacus consequat, ac rutrum magna tincidunt. Sed in bibendum nisl. Sed
                        commodo, sapien quis vestibulum interdum, enim sapien ultrices massa, id imperdiet ipsum metus vel lorem.
                        Donec rhoncus nisi ac risus congue commodo. Maecenas ac bibendum orci.
                    </p>
                    <br />
                    <p>
                        ...
                        dictum dui vel sem porttitor, in auctor lacus malesuada. Maecenas vel sapien ultrices, consequat justo
                        sed, placerat mauris.
                    </p>
                </BlogPost>
                ...
                <BlogPost title="Works even on dynamic buttons" author="TheWeakNinja" date="January 1, 2021">
                    <p>
                        ...
                        sapien. Fusce commodo ipsum eu lacus consequat, ac rutrum magna tincidunt. Sed in bibendum nisl. Sed
                        commodo, sapien quis vestibulum interdum, enim sapien ultrices massa, id imperdiet ipsum metus vel lorem.
                        Donec rhoncus. Infinity War isn&apos;t a movie, it&apos;s a documentary. Why else would Thanos look so
                        real?
                    </p>
                    <br />
                    <p>
                    ...
                    <p>
                        ...
                        Suspendisse potenti. Nam id sem euismod, volutpat risus at, bibendum quam. Nunc nec aliquam neque. Vivamus
                        dictum dui vel sem porttitor, in auctor lacus malesuada. Maecenas vel sapien ultrices, consequat justo
                        sed, placerat mauris. It does not break (yet) when you use it with Framer Motion&apos;s AnimatePresence.
                    </p>
                </BlogPost>
            </div>
            <MagneticButton
